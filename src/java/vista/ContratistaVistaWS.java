...
import wsclient.ContratistaWSCliente;

/**
 *
 * @author Jhon
 */
@Named(value = "contratistaVistaWS")
@RequestScoped // tipo de vista cuando cree la clase
public class ContratistaVistaWS {
    
    private ContratistaWSCliente contratistaCliente;
     ...
     */
    public ContratistaVistaWS() {
        contratistaCliente = new ContratistaWSCliente();
    }

    public List<Contratista> getListaContratista() {
        String datosWS = contratistaCliente.findAll_JSON(String.class);
        System.out.println(datosWS);
        Gson gson = new Gson();
        Type tipoListaContratista = new TypeToken<List<Contratista>>(){}.getType();
        listaContratista = gson.fromJson(datosWS, tipoListaContratista);
